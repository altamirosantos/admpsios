        ...
        this.model = [
            ...
            },
            {
                ...
                items: [
                    ...
                    { label: 'Colaboradores', icon: 'pi pi-fw pi-users', routerLink: ['/pages/colaboradores'] },
                    { label: 'Setores', icon: 'pi pi-fw pi-th-large', routerLink: ['/pages/setores'] },
                    ...
                    { label: 'Modelos', icon: 'pi pi-fw pi-file', routerLink: ['/pages/modelos-proposta'] },
