...
import { AutoavaliacaoService } from 'src/app/demo/service/autoavaliacao.service';

@Component({
    selector: 'app-termometro-index',
    standalone: false,
    templateUrl: './autoavaliacoes-index.component.html',
    styleUrl: './autoavaliacoes-index.component.scss',
    providers: [MessageService]
})
export class AutoavaliacoesIndexComponent {
    autoavaliacoes: any[] = [];
    ...
    async ngOnInit() {
        this.loading = true;
        this.autoavaliacoes = await this.autoavaliacaoService.getAll();
